...
- 当前基线 = v2.9.0 **已全渠道发行**（2026-09-16：GitHub Release / npm 2.9.0 / Gitee / ClawHub 1.0.17 / About 双端；2.9 修正批——独立审查 P1×11+P2×16 机制级 23 项+v11 四项裁决+G 清单四点立条 #333-#335+security 应用安全基线节 OWASP 2025+G 直写批 #336-#344+#295 双击转正+推荐序施工批 #345+思考链 hooks 行，细则 330→344·25 类）；跑前确认注入副本已重部署且新会话读到「在场提示 · v2.9.0」。
