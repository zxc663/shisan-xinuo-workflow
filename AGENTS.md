...
- 下一轮路测基线 = 本版（v2.9.0，2026-09-15/16：2.9 修正批——独立审查 P1×11+P2×16 机制级 23 项+v11 四项裁决+G 清单四点立条 #333-#335+security 应用安全基线节 OWASP 2025+G 直写批 #336-#344+#295 双击转正（长驻进程清理），细则 330→344·25 类；v2.8.0 已全渠道发行+路测 v11 全量收官）；跑前确认注入副本已重部署且新会话读到「在场提示 · v2.9.0」。
