...
- 下一轮路测基线 = 本版（v2.8.0，2026-09-14：2.7.2 修正批并入升板——每轮复述强制/压缩接续+重载在用 Skills/GATE refs 实测/系统级可逆配置判级/开工前置强制门 #332/回指加载/Bash 失败守卫 post_tool_guard/UserPromptSubmit 每轮再触达，细则 322→330；路测 v10 全绿 EVIDENCE §二十九）；跑前确认注入副本已重部署且新会话读到「在场提示 · v2.8.0」。
