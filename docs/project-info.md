...
> 更新：2026-09-15 ｜ 判级：L2-F v2.9.0 修正批（独立审查 P1×11+P2×16 机制级 23 项+v11 四项裁决+G 清单四点立条；facts_sync 类数/节头断言升级；verify 7/7；细则 344 条/25 类）｜ 签章：v2.7+ 重构施工计划已获用户全量批准+全部预授权（2026-09-12，批 0-5 分批自主推进）；v2.8.0 已全渠道发行（2026-09-15，回执见项目信息 §五）；**v2.9.0 批次施工完成待发行**。
...
- 当前：**v2.9.0 批次（施工完成待发行）**——2.9 修正批 23 机制级+v11 四项裁决+G 清单四点立条 #333-#335+G 直写批 #336-#344+#295 双击转正；细则 344 条/25 类（终态；v2.8.0 发行时点 330/17）；五副本重部署 count=343 5/5；路测 v11 全量收官（EVIDENCE §三十一）；**口径修正批已落地（2026-09-16 审查批 docs/audit-v290-review-20260916.md：A 族 9 处+同族 5 处+B 族 3 处全修+facts_sync CARRIERS 补两面）**。
