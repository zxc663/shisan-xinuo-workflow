...
> 更新：2026-09-15 ｜ 判级：L2-F v2.8.0 定调+审查修正（独立审查 30 项 P0 当轮闭环/P1+P2 入 2.9；facts_sync 事实对账 verify 7/7；细则 330 条/17 类）｜ 签章：v2.7+ 重构施工计划已获用户全量批准+全部预授权（2026-09-12，批 0-5 分批自主推进）；v2.8.0 发行前准备批已获用户批准（2026-09-15，push/发行单独批准）。
