...
- 版本：v2.7.0（**唯一中文版主交付物**——v2.0 起单版本，英文 / 双语版已删除，git 历史可追溯；README 双语保留；**v2.0.6（2026-08-31）/ v2.1.0 / v2.1.1 / v2.2.0 / v2.3.0 / v2.5.0（2026-09-08，Gitee 侧待补）/ v2.6.0（2026-09-09，Gitee 侧待补）已发行**；v2.4.0 三平台取证驱动修补+细则分层蒸馏（内容并入 v2.5.0 发行）为本地批次（2026-09-08）；v2.7+ 重构六批次（条款六销项+注入核心瘦身 5,203+hooks 纪律包+判例审入活跃 303+收口定稿+路测 v6 修正批活跃 309）为本地批次（2026-09-12），发行面另行批准）
